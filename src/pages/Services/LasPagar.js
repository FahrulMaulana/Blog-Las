...
function LasPagar() {
  const handleWhatsApp = () => {
    window.open("https://wa.me/081212154019?text=Halo, saya ingin konsultasi tentang jasa las pagar", "_blank");
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Jasa las pagar besi hollow minimalis di Depok, Pamulang, BSD. Pagar rumah, pagar besi, pagar hollow kuat & estetis. Free survey. Telp 081212154019" />
        <meta name="keywords" content="jasa las pagar depok, pagar besi minimalis, pagar hollow, harga pagar per meter, tukang pagar terdekat, pagar rumah minimalis" />
        ...
        <meta property="og:description" content="Jasa las pagar profesional. Free survey & pemasangan. Area Depok, Pamulang, BSD." />
      ...
      <Card sx={{ p: 2, mx: { xs: 2, lg: 3 }, mt: -8, mb: 4, backgroundColor: ({ palette: { white }, functions: { rgba } }) => rgba(white.main, 0.9), backdropFilter: "saturate(200%) blur(30px)", boxShadow: ({ boxShadows: { xxl } }) => xxl }}>
        <Container>
          <Grid container spacing={3} sx={{ mt: 6 }}>
            <Grid item xs={12} lg={8}>
              <MKTypography variant="h2" mb={3}>Pagar Rumah Berkualitas untuk Keamanan & Estetika</MKTypography>
              
              <MKTypography variant="body1" color="text" mb={2}>
                Pagar adalah elemen penting untuk keamanan dan privasi rumah Anda. <strong>Indian Jaya Las</strong> menyediakan jasa pembuatan pagar besi hollow dengan desain minimalis modern yang tidak hanya kuat, tetapi juga menambah nilai estetika rumah Anda.
              </MKTypography>

              <MKTypography variant="h3" mt={4} mb={2}>Jenis Pagar yang Kami Tawarkan</MKTypography>
              ...
              <MKBox component="table" width="100%" sx={{ border: "1px solid #ddd", borderCollapse: "collapse", "& td, & th": { border: "1px solid #ddd", padding: "12px" }, "& th": { backgroundColor: "#f8f9fa", fontWeight: "bold" } }}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td><MKTypography variant="body2">Pagar Kombinasi (Besi + Kayu)</MKTypography></td>
      ...
      <MKBox position="fixed" bottom="20px" right={{ xs: "20px", lg: "40px" }} zIndex="1000" sx={{ cursor: "pointer", boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.1)", borderRadius: "50%" }} onClick={handleWhatsApp}>
        <img src="/wa.png" alt="WhatsApp Indian Jaya Las" style={{ width: "60px", height: "60px" }} />
      </MKBox>
    </>
  );
}
