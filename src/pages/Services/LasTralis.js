          ...
          <Grid container spacing={3} sx={{ mt: 6 }}>
            <Grid item xs={12} lg={8}>
              ...
              <MKTypography variant="body1" mb={2}>
                Tralis atau terali besi adalah pengaman jendela dan pintu yang wajib dimiliki setiap rumah. <strong>Indian Jaya Las</strong> menyediakan berbagai desain tralis, dari yang minimalis hingga motif artistik untuk melengkapi keamanan dan estetika rumah Anda.
              </MKTypography>

              <MKTypography variant="body1" color="text" mb={2}>
                Dengan material berkualitas dan pemasangan profesional, tralis kami menjamin keamanan maksimal tanpa mengurangi nilai estetika rumah Anda.
              </MKTypography>

              <MKTypography variant="h3" mt={4} mb={2}>Jenis Tralis yang Kami Tawarkan</MKTypography>
              <MKBox component="ul" sx={{ pl: 3 }}>
                <li><MKTypography variant="body1" mb={1}><strong>Tralis Minimalis</strong> - Sederhana, modern, cocok untuk rumah minimalis</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}><strong>Tralis Motif</strong> - Artistik dan dekoratif dengan berbagai pola</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}><strong>Tralis Jendela</strong> - Standar keamanan tinggi untuk semua jenis jendela</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}><strong>Tralis Pintu</strong> - Pengaman pintu utama dan pintu belakang</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}><strong>Tralis Custom</strong> - Desain sesuai keinginan Anda</MKTypography></li>
              </MKBox>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                  <MKBox bgColor="success" color="white" borderRadius="md" p={2} mb={2}>
                    <MKTypography variant="h6" color="white" mb={1}>🔒 Keamanan Maksimal</MKTypography>
                    <MKTypography variant="body2" color="white">Material kuat dan pemasangan kokoh</MKTypography>
                  </MKBox>
                </Grid>
                <Grid item xs={12} md={6}>
                  <MKBox bgColor="info" color="white" borderRadius="md" p={2} mb={2}>
                    ...
                    <MKTypography variant="body2" color="white">Sesuaikan dengan gaya rumah Anda</MKTypography>
                  </MKBox>
                </Grid>
                <Grid item xs={12} md={6}>
                  <MKBox bgColor="warning" color="white" borderRadius="md" p={2} mb={2}>
                    <MKTypography variant="h6" color="white" mb={1}>⚡ Pemasangan Cepat</MKTypography>
                    <MKTypography variant="body2" color="white">Tim profesional berpengalaman</MKTypography>
                  </MKBox>
                </Grid>
                <Grid item xs={12} md={6}>
                  <MKBox bgColor="error" color="white" borderRadius="md" p={2} mb={2}>
                    <MKTypography variant="h6" color="white" mb={1}>💰 Harga Terjangkau</MKTypography>
                    <MKTypography variant="body2" color="white">Kualitas premium dengan harga kompetitif</MKTypography>
                  </MKBox>
                </Grid>
              </Grid>

              <MKTypography variant="h3" mt={4} mb={2}>Estimasi Harga Tralis Per Meter (2026)</MKTypography>
              <MKBox component="table" width="100%" sx={{ border: "1px solid #ddd", borderCollapse: "collapse", "& td, & th": { border: "1px solid #ddd", padding: "12px" }, "& th": { backgroundColor: "#f8f9fa", fontWeight: "bold" } }}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td><MKTypography variant="body2">Tralis Custom Eksklusif</MKTypography></td>
              ...
              <MKTypography variant="body2" color="text" mt={2} fontStyle="italic">
                *Harga dapat berubah sewaktu-waktu tergantung ketersediaan material dan kompleksitas desain.
              </MKTypography>

              <MKTypography variant="h3" mt={4} mb={2}>Cara Pesan Tralis Custom</MKTypography>
              <MKBox component="ol" sx={{ pl: 3 }}>
                ...
                <li><MKTypography variant="body1" mb={1}>Konsultasikan kebutuhan dan desain yang diinginkan</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}>Tim kami akan survey ke lokasi (GRATIS)</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}>Dapatkan estimasi harga dan waktu pengerjaan</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}>Pengerjaan dan pemasangan oleh teknisi ahli</MKTypography></li>
                <li><MKTypography variant="body1" mb={1}>Selesai dan siap digunakan</MKTypography></li>
              </MKBox>

              <MKTypography variant="h3" mt={4} mb={2}>Area Layanan Tralis</MKTypography>
              <Grid container spacing={2}>
