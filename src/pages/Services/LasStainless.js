...
function LasStainless() {
  const handleWhatsApp = () => {
    window.open(
      "https://wa.me/6281212154019?text=Halo, saya ingin konsultasi tentang jasa las stainless",
      "_blank"
    );
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Jasa las stainless steel di Depok & Tangerang Selatan. Pagar stainless, railing tangga, kanopi stainless. Anti karat, awet. Telp 081212154019"
        />
        <meta
          name="keywords"
      ...
      <Breadcrumb items={[
        ...
        { name: "Las Stainless", path: "/las-stainless", url: "https://indianjayalas.com/las-stainless" },
      ]} />
          ...
          <Grid container spacing={3} sx={{ mt: 6 }}>
            <Grid item xs={12} lg={8}>
              <MKTypography variant="h2" mb={3}>
                Stainless Steel - Material Premium untuk Rumah Modern
              </MKTypography>
              <MKTypography variant="body1" mb={2}>
                Stainless steel adalah material premium yang tahan karat, awet puluhan tahun, dan
                memiliki tampilan mengkilap yang elegan. <strong>Indian Jaya Las</strong> ahli dalam
                pembuatan berbagai produk stainless steel untuk rumah dan komersial.
              </MKTypography>

              <MKTypography variant="h3" mt={4} mb={2}>
                Produk Stainless Steel Kami
              </MKTypography>
              <MKBox component="ul" sx={{ pl: 3 }}>
                <li>
                  <MKTypography variant="body1" mb={1}>
                    <strong>Pagar Stainless</strong> - Elegan dan tahan lama
                  </MKTypography>
                </li>
                <li>
                  <MKTypography variant="body1" mb={1}>
                    <strong>Railing Tangga Stainless</strong> - Modern dan aman
                  </MKTypography>
                </li>
                <li>
                  <MKTypography variant="body1" mb={1}>
                    <strong>Kanopi Rangka Stainless</strong> - Premium quality
                  </MKTypography>
                </li>
                <li>
                  <MKTypography variant="body1" mb={1}>
                    <strong>Pintu & Jendela Stainless</strong> - Anti karat maksimal
                  </MKTypography>
                </li>
                <li>
                  <MKTypography variant="body1" mb={1}>
                    <strong>Balkon Stainless</strong> - Estetik dan kuat
                  </MKTypography>
                </li>
              </MKBox>
                ...
                <Grid item xs={12} md={6}>
                  <MKBox bgColor="success" color="white" borderRadius="md" p={2} mb={2}>
                    ...
                    <MKTypography variant="body2" color="white">
                      Tidak berkarat meski terkena air & cuaca ekstrem
                    </MKTypography>
                  </MKBox>
                </Grid>
                <Grid item xs={12} md={6}>
              ...
              <MKTypography variant="h3" mt={4} mb={2}>
                Estimasi Harga Stainless Steel Per Meter (2026)
              </MKTypography>
              <MKBox
                component="table"
                width="100%"
              ...
              >
                ...
                <tbody>
                  <tr>
                    <td>
                      <MKTypography variant="body2">Pagar Stainless</MKTypography>
                    </td>
                    <td>
                      <MKTypography variant="body2">Rp 500.000 - Rp 800.000</MKTypography>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <MKTypography variant="body2">Railing Tangga Stainless</MKTypography>
                    </td>
                    <td>
                      <MKTypography variant="body2">Rp 450.000 - Rp 700.000</MKTypography>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <MKTypography variant="body2">Balkon Stainless</MKTypography>
                    </td>
                    <td>
                      <MKTypography variant="body2">Rp 600.000 - Rp 900.000</MKTypography>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <MKTypography variant="body2">Kanopi Rangka Stainless</MKTypography>
                    </td>
                    <td>
                      <MKTypography variant="body2">Rp 550.000 - Rp 850.000</MKTypography>
                    </td>
                  </tr>
                </tbody>
              </MKBox>
              ...
              <MKTypography variant="body2" color="text" mt={2} fontStyle="italic">
                *Harga material premium stainless steel dapat berubah sesuai grade dan finishing
                yang dipilih.
              </MKTypography>

              <MKTypography variant="h3" mt={4} mb={2}>
                Cara Pesan Produk Stainless Custom
              </MKTypography>
              <MKBox component="ol" sx={{ pl: 3 }}>
                ...
                <li>
                  <MKTypography variant="body1" mb={1}>
                    Konsultasikan kebutuhan dan pilihan desain
                  </MKTypography>
                </li>
                <li>
                  <MKTypography variant="body1" mb={1}>
                ...
                <li>
                  <MKTypography variant="body1" mb={1}>
                    Pilih grade stainless dan finishing yang sesuai
                  </MKTypography>
                </li>
                <li>
                  <MKTypography variant="body1" mb={1}>
                    Pengerjaan oleh ahli las stainless bersertifikat
                  </MKTypography>
                </li>
                <li>
                  <MKTypography variant="body1" mb={1}>
                    Pemasangan rapi dan garansi kualitas
                  </MKTypography>
                </li>
              </MKBox>

              <MKTypography variant="h3" mt={4} mb={2}>
                Area Layanan Las Stainless
              </MKTypography>
              <Grid container spacing={2}>
                {[
                  "Depok",
